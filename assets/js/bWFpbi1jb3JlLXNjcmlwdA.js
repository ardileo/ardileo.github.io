$(function() {
    ...
    $("body").append('<a href="#" class="back-to-top"><i class="fa fa-chevron-up"></i></a><div id="preloader"></div>');

    jQuery.ajaxSetup({ async: false }); //if order matters
    $.get("assets/section-footscript.html", '', function (data) { $("body").append(data); });
    $.get("assets/section-nav.html", '', function (data) { $("body").prepend(data); });
    $.get("assets/section-intro.html", '', function (data) {  $("body").append(data); });
    // $.get("assets/section-service.html", '', function (data) { root.append(data); });
    $.get("assets/section-portfolio.html", '', function (data) { $("body").append(data); });
    ...
    $.get("assets/section-contact.html", '', function (data) { $("body").append(data); });
