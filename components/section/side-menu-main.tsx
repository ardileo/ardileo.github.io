...
export default function SideMenuMain() {
    ...
    const socialMedia = [
        ...
        { 'id': 'instagram', 'icon': <SiInstagram />, 'url': 'https://www.instagram.com/nagaleyo/' },
            ...
            <Stack
                ...
                {socialMedia.map((item) => {
                    return (
                        <IconButton
                            key={item.id}
                            onClick={(e) => item.url ? window.open(item.url, '_blank') : e.preventDefault()}
                            size="lg"
